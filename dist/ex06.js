...
function exibirDiretor(diretor) {
    const salarioOpcional = diretor.salario
        ? `R$ ${diretor.salario.toFixed(2)}`
        : "N/A";
    console.log(`Diretor(a) ${diretor.nome}, ${diretor.idade} anos, comissão nível ${diretor.nivelComissionamento}, salário R$ ${salarioOpcional}`);
}
const diretor1 = {
    nome: "Daphene",
    idade: 23,
